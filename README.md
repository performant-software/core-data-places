...
| content.posts_config.sort_by                                    | String  | If set to `date`, posts will display in reverse chronological order. No other value does anything for now (but could in future updates)                                                      |
