...
| content.collections                    | Array   | Array of content keys to allow for data entry and routing: "posts", "paths", "pages"                                                                                  |
| content.localize                       | Boolean | If `true` pages content will be pulled from a locale directory (e.g. `/en/My-Awesome-Page.mdx`)                                                                       |
