...
| search.type                            | String  | If `map`, the map search component will be used. If `list` or `grid`, the non-map search component will be used with the corresponding layout. Defaults to `map` when not present. |
