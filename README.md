...
| detail_pages.relationship_fields.organizations | Array   | List of fields to display in the related record components for related organizations                                                                                                         |
| detail_pages.relationship_fields.people        | Array   | List of fields to display in the related record components for related people                                                                                                                |
| detail_pages.relationship_fields.places        | Array   | List of fields to display in the related record components for related places                                                                                                                |
| detail_pages.relationship_fields.taxonomies    | Array   | List of fields to display in the related record components for related taxonomies                                                                                                            |
