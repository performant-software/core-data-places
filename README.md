...
| search.static.model_ids                                                   | Array   | UUIDs of the project models whose records are included. Each must belong to a project in `core_data.project_ids` and match the model type indicated by `search.route`                                       |
...
| search.typesense                                                          | Object  | Typesense index connection information. Required unless `search.static` is set                                                                                                                              |
