...
| detail_pages.models.<modelname>.editioncrafter_config.transcription_types|Object| Key-value pairs for the xml:id and label of the text resources in the project's TEI documents, to be passed to EditionCrafter                                                          |
